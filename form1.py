...
# 添加button按钮
# 添加消息框
# t1 =tkinter.Label(nW, text='你好！this is Tkinter', bg='green', font=('Arial', 12), width=10, height=1)
# t1.grid(row=0, column=0)
# b1 = tkinter.Button(nW, text="按钮")
# b1.grid(row=0, column=1, padx=10)
var = tk.StringVar()  # 将label标签的内容设置为字符类型，用var来接收hit_me函数的传出内容用以显示在标签上
l = tk.Label(nW, text="请输入汉字:", bg='green', fg='white', font=('Arial', 10), width=20, height=2)
# 说明： bg为背景，fg为字体颜色，font为字体，width为长，height为高，这里的长和高是字符的长和高，比如height=2,就是标签有2个字符这么高
l.grid(row=0, padx='10', pady='10')
l1 = tk.Label(nW, text="请输入单词:", bg='green', fg='white', font=('Arial', 10), width=20, height=2)
# 说明： bg为背景，fg为字体颜色，font为字体，width为长，height为高，这里的长和高是字符的长和高，比如height=2,就是标签有2个字符这么高
l1.grid(row=1)
entry1 = tk.Entry(nW)
entry2 = tk.Entry(nW)
